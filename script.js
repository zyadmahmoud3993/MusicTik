...
window.onload = () => {
    ...
    <div class="upcontaner">
        ...
        <div class="contaner">
            ...
            <div class="boxmusic ${pcOrmobile}" id="three"
            ...
            <div class="boxmusic ${pcOrmobile}" id="four" onclick="PlayBox('music/lo-fi-kick.wav', 'music/short-tekno-kick_C_major.wav')"
                style="--color:red; --color2:rgb(55, 0, 255);">
            </div>
            <div class="boxmusic ${pcOrmobile}" id="five"
            ...
            <div class="boxmusic ${pcOrmobile}" id="six" onclick="PlayBox('music/rdo-hat_C_major.wav', 'music/techno-kick-punch.wav')"
                style="--color:orange; --color2:rgb(0, 4, 255);"></div>
            <div class="boxmusic ${pcOrmobile}" id="seven" onclick="PlayBox('music/wrk-hat.wav', 'music/tekno-kick-crunch.wav')"
                style="--color:rgb(0, 255, 115); --color2:rgb(98, 0, 255);"></div>
            <div class="boxmusic ${pcOrmobile}" id="eight" onclick="PlayBox('music/smooth-lo-fi-hat_A.wav', 'music/tekno-bass-kick_A.wav')"
                style="--color:rgb(255, 0, 106); --color2:rgb(255, 145, 0);"></div>
            <div class="boxmusic ${pcOrmobile}" id="nine" onclick="PlayBox('music/ykz-hat_C_minor.wav', 'music/tekno-kick-aggressive.wav')"
                style="--color:rgb(187, 18, 32); --color2:rgb(55, 0, 255);"></div>
            <div class="boxmusic ${pcOrmobile}" id="ten"
            ...
            <div class="boxmusic ${pcOrmobile}" id="Eleven" onclick="PlayBox('music/flux-hi-hats_.mp3', 'music/tekno-kicks-aggressive-fa.wav')"
                style="--color:rgb(195, 0, 255); --color2:rgb(76, 0, 255);"></div>
            <div class="boxmusic ${pcOrmobile}" id="twelve"
    ...
    <div class="Note" dir="auto">
        ...
        <ul>
            ...
            <li>اذا كنت تريد الحصول على تجربة افضل قم بتوصيل سماعات الرأس</li>
